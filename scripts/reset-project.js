 ...
 * It deletes or moves the /src and /scripts directories to /example based on user input and creates a new /src/app directory with an App.tsx and _layout.tsx file.
...
const moveDirectories = async (userInput) => {
  try {
    ...
    console.log("📄 src/app/App.tsx created.");
